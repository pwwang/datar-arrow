...
@pytest.mark.parametrize(
    ...
    [
        (min_, [1, 2, 3], False, 1),
        (min_, [1, 2, 3], True, 1),
        (min_, [1, 2, 3, NA], False, NA),
        (min_, [1, 2, 3, NA], True, 1),
        (max_, [1, 2, 3], False, 3),
        (max_, [1, 2, 3], True, 3),
        (max_, [1, 2, 3, NA], False, NA),
        (max_, [1, 2, 3, NA], True, 3),
        (sum_, [1, 2, 3], False, 6),
        (sum_, [1, 2, 3], True, 6),
        (sum_, [1, 2, 3, NA], False, NA),
        (sum_, [1, 2, 3, NA], True, 6),
        (prod, [1, 2, 3], False, 6),
        (prod, [1, 2, 3], True, 6),
        (prod, [1, 2, 3, NA], False, NA),
        (prod, [1, 2, 3, NA], True, 6),
        (sd, [1, 2, 3], False, 1.0),
        (sd, [1, 2, 3], True, 1.0),
        (sd, [1, 2, 3, NA], False, NA),
        (sd, [1, 2, 3, NA], True, 1.0),
    ],
)
...
def test_weighted_mean():
    ...
    assert_equal(weighted_mean(x, w3), NA)
    assert_equal(weighted_mean(x2, w2, na_rm=True), NA)
    assert_equal(weighted_mean(x, w4), NA)
...
def test_quantile():
    ...
    assert_iterable_equal(
        quantile([*x, NA], [0.25, 0.75], na_rm=True),
        [1.5, 2.5],
    )
